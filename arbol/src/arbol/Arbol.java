...
public class Arbol {
	...
	public Arbol(int id, String nombreComun, String nombreCientifico, String habitat, int altura, boolean singular,
			String origen, Habitad habitats, Date fecha_encontrado) {
		this.id = id;
	...
	public String toString() {
		return "Arbol [id=" + id + ", nombreComun=" + nombreComun + ", nombreCientifico=" + nombreCientifico
				+ ", habitat=" + habitat + ", altura=" + altura + ", singular=" + singular + ", origen=" + origen
				+ ", habitats=" + habitats + ", fecha_encontrado=" + fecha_encontrado + "]";
	}
